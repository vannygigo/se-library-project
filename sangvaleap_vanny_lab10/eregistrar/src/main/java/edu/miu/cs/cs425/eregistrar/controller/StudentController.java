...
@Controller
@RequestMapping(value = { "/eregister/student" })
public class StudentController {
    ...
    public String displayEditStudent(@PathVariable Long studentId, Model model) {
    ...
    public ModelAndView searchStudents(@RequestParam String searchString) {
        if (searchString.isBlank()) {
            return new ModelAndView("redirect:/eregister/student/list");
        }
        var modelAndView = new ModelAndView();
